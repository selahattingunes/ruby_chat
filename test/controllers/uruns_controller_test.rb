...
class UrunsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create urun" do
    assert_difference('Urun.count') do
      post uruns_url, params: { urun: { aciklama: @urun.aciklama, baslik: @urun.baslik, fiyat: @urun.fiyat } }
    end
  ...
  test "should update urun" do
    patch urun_url(@urun), params: { urun: { aciklama: @urun.aciklama, baslik: @urun.baslik, fiyat: @urun.fiyat } }
